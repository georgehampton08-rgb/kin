...
Revision ID: 5b76f9c889a9
Revises: d4b7f2a91e3c
Create Date: 2026-03-04 10:45:37.966864
...
revision: str = '5b76f9c889a9'
down_revision: Union[str, Sequence[str], None] = 'd4b7f2a91e3c'
...
def upgrade() -> None:
    ...
    op.drop_table('layer')
    op.add_column('zones', sa.Column('zone_type', sa.String(), nullable=True))
